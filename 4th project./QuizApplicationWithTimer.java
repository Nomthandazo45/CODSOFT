...
class QuizApplicationWithTimer {
    ...
    public QuizApplicationWithTimer() {
        ...
        quizQuestions.add(new QuizQuestion("What is the capital of South Africa?", Arrays.asList("A. Johannesburg", "B. Pretoria", "C. Durban", "D. Port Elizabeth"), 1));
        ...
        quizQuestions.add(new QuizQuestion("What is the world's most popular social media platform?", Arrays.asList("A. Instagram", "B. Facebook", "C. Tik Tok", "D. Twitter"), 4));
        quizQuestions.add(new QuizQuestion("What is the world's most popular programming language?", Arrays.asList("A. Python", "B. SQL", "C. JavaScript", "D. HTML/CSS"), 5));
        // questions
    }
    ...
    public void startQuiz() {
        ...
        }, 10000); // Change the time limit here (in milliseconds)
